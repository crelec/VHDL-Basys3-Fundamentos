...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/Serial-TX/Serial-TX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Transmisor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Transmisor.tcl -notrace
