...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/Serial-TX/Serial-TX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Transmisor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Transmisor.tcl
