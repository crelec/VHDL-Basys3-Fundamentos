...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/DetectaSucuencia/DetectaSucuencia.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Maq_Estado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Maq_Estado.tcl
