...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/DetectaSucuencia/DetectaSucuencia.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Maq_Estado.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Maq_Estado.tcl -notrace
