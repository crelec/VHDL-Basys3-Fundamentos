...
HD_PWD='C:/Repo-Asus-2026/MaqEstadoDosB/MaqEstadoDosA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Estados.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Estados.tcl
