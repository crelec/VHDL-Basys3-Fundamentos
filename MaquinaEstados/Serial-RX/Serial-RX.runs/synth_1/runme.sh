...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/Serial-RX/Serial-RX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Receptor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Receptor.tcl
