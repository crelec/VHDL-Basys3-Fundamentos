...
HD_PWD='C:/Repo-Asus-2026/MaqEstadoDosC/MaqEstadoDosA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Estados.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Estados.tcl -notrace
