...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/DetectaSecuencia101/DetectaSecuencia101.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DecSecuencia.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DecSecuencia.tcl
