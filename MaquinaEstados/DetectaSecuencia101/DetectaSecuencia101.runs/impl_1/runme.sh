...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/MaquinaEstados/DetectaSecuencia101/DetectaSecuencia101.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DecSecuencia.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DecSecuencia.tcl -notrace
