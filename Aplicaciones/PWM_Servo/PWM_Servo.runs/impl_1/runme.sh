...
HD_PWD='C:/Users/cerom/OneDrive/Documentos/Repo-ASUS/VHDL-Basys3/Aplicaciones/PWM_Servo/PWM_Servo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPWM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopPWM.tcl -notrace
