...
HD_PWD='C:/Users/cerom/OneDrive/Documentos/Repo-ASUS/VHDL-Basys3/Aplicaciones/PWM_Servo/PWM_Servo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPWM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopPWM.tcl
