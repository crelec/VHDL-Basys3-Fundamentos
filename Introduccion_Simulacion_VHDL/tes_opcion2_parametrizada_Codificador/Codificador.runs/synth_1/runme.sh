...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Introduccion_Simulacion_VHDL/tes_opcion2_parametrizada_Codificador/Codificador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Codi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Codi.tcl
