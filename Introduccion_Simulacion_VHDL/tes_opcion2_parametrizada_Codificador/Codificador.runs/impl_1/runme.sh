...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Introduccion_Simulacion_VHDL/tes_opcion2_parametrizada_Codificador/Codificador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Codi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Codi.tcl -notrace
