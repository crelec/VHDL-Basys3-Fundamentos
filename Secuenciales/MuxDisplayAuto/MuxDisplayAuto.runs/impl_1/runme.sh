...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/MuxDisplayAuto/MuxDisplayAuto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SupMuxDisplayAuto.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SupMuxDisplayAuto.tcl -notrace
