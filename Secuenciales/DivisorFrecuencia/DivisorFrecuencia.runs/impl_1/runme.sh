...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/DivisorFrecuencia/DivisorFrecuencia.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Divisor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Divisor.tcl -notrace
