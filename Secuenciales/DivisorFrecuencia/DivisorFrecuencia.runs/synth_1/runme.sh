...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/DivisorFrecuencia/DivisorFrecuencia.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Divisor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Divisor.tcl
