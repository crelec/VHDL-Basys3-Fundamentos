...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/ContadorBinarioControl/ContadorBinario.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SupContador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SupContador.tcl
