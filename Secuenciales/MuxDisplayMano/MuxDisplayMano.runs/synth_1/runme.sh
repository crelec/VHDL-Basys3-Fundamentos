...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/MuxDisplayMano/MuxDisplayMano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopMuxDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopMuxDisplay.tcl
