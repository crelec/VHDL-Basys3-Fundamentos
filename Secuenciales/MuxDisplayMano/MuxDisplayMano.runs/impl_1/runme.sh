...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/MuxDisplayMano/MuxDisplayMano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopMuxDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopMuxDisplay.tcl -notrace
