...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/PublickDesplaza/PublickDesplaza.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulotop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulotop.tcl
