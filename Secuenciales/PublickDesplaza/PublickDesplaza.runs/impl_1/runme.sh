...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/PublickDesplaza/PublickDesplaza.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulotop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulotop.tcl -notrace
