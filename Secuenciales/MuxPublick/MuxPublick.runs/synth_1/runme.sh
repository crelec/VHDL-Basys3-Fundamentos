...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/MuxPublick/MuxPublick.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SupMuxPublick.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SupMuxPublick.tcl
