...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/MuxPublick/MuxPublick.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SupMuxPublick.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SupMuxPublick.tcl -notrace
