...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Secuenciales/publick7seg/publick7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SupPublick.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SupPublick.tcl
