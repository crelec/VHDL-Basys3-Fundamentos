...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Demultiplexor/Demultiplexor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Demux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Demux.tcl -notrace
