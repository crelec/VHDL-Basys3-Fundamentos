...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Demultiplexor/Demultiplexor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Demux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Demux.tcl
