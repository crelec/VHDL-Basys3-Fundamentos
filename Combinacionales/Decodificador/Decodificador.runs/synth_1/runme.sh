...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Decodificador/Decodificador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deco.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deco.tcl
