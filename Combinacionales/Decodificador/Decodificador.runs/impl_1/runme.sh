...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Decodificador/Decodificador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log deco.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source deco.tcl -notrace
