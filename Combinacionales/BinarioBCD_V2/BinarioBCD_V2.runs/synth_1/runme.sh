...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/BinarioBCD_V2/BinarioBCD_V2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bin_BCD2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bin_BCD2.tcl
