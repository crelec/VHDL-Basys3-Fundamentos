...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/BinarioBCD_V2/BinarioBCD_V2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bin_BCD2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bin_BCD2.tcl -notrace
