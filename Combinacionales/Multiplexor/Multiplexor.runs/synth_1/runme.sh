...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Multiplexor/Multiplexor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModuloMux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModuloMux.tcl
