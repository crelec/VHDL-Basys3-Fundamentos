...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Ejemplo-mux-whenElse/with-select-mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Caso.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Caso.tcl
