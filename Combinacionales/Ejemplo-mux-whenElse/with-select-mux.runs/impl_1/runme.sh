...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Ejemplo-mux-whenElse/with-select-mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Caso.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Caso.tcl -notrace
