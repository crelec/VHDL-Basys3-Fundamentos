...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Display7segmento/Display7segmento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModuloDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModuloDisplay.tcl
