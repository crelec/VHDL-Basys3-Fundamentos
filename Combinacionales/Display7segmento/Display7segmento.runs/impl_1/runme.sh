...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/Display7segmento/Display7segmento.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ModuloDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ModuloDisplay.tcl -notrace
