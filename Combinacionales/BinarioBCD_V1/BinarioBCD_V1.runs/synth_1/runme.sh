...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/BinarioBCD_V1/BinarioBCD_V1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BIn_BCD1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BIn_BCD1.tcl
