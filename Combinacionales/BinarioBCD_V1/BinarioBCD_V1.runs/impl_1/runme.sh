...
HD_PWD='C:/Repo-Asus-2026/VHDL-Basys3/Combinacionales/BinarioBCD_V1/BinarioBCD_V1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BIn_BCD1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BIn_BCD1.tcl -notrace
