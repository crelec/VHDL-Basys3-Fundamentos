...
HD_PWD='C:/Users/cerom/OneDrive/Documentos/Repo-ASUS/VHDL-Basys3/Combinacionales/Bus_datos/Bus_datos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bus_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bus_Top.tcl -notrace
